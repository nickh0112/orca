        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-zinc-500 max-w-xs">
              AI-powered creator vetting for modern brands.
            </p>
          </div>

          {/* Product links */}
          <div>
            <h4 className="text-xs text-zinc-500 uppercase tracking-wider mb-4">Product</h4>
          ...
          {/* Company links */}
          <div>
            <h4 className="text-xs text-zinc-500 uppercase tracking-wider mb-4">Company</h4>
            <ul className="space-y-3">
          ...
          {/* Legal links */}
          <div>
            <h4 className="text-xs text-zinc-500 uppercase tracking-wider mb-4">Legal</h4>
            <ul className="space-y-3">
